...
<section class="tx-section tx-about">
  <div class="md-grid">
    <div class="tx-about__inner">
      <img src="assets/phytospatial-logo.png" alt="Phytospatial Logo" width="200">
...
<section class="tx-section tx-features" data-md-color-scheme="slate">
  <div class="md-grid">
    ...
    <div class="tx-feature">
      ...
      <p>Specialized tools tailored for tree crown validation, species labeling, and passive-active raster-level fusion.</p>
    </div>
    <div class="tx-feature">
      <span class="twemoji">
  ...
  <div class="md-grid">
    ...
    <div class="tx-collaborators__grid">
      <div class="tx-profile">
        <img src="assets/louis.jpg" alt="Louis-Vincent Grand'Maison">
...
<section class="tx-section tx-contact" data-md-color-scheme="slate">
  <div class="md-grid md-content__inner mdx-content__inner">
    <div class="mdx-content__column">
      <header class="md-typeset">
        <h1 id="keep-in-touch">Let's keep in touch</h1>
      </header>
      <div class="mdx-connect md-typeset">
        <div class="mdx-connect__inner">
          <p>
            <a href="https://github.com/Louis-Gm/phytospatial" class="mdx-connect__link">
              <span class="twemoji">
              ...
              Phytospatial on <strong>GitHub</strong>
            </a>
          </p>
          <p>
            <a href="https://pypi.org/project/phytospatial/" class="mdx-connect__link">
              <span class="twemoji">
              ...
              Phytospatial on <strong>PyPI</strong>
            </a>
          </p>
          <p>
            <a href="https://doi.org/10.5281/zenodo.18112045" class="mdx-connect__link">
              <span class="twemoji">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <path d="M444.5 64H67.5C30.2 64 0 94.2 0 131.5v249c0 37.3 30.2 67.5 67.5 67.5h377c37.3 0 67.5-30.2 67.5-67.5v-249c0-37.3-30.2-67.5-67.5-67.5zM256 400c-79.5 0-144-64.5-144-144s64.5-144 144-144 144 64.5 144 144-64.5 144-144 144zm0-240c-53 0-96 43-96 96s43 96 96 96 96-43 96-96-43-96-96-96z"/>
                </svg>
              </span>
              Cite us on <strong>Zenodo</strong>
            </a>
          </p>
          <p>
            <a href="https://www.linkedin.com/company/phytospatial/" class="mdx-connect__link">
              <span class="twemoji">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
